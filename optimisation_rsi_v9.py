...
- EMA de tendance (sur le cours, pas le RSI) : 3 à 80 semaines par pas
  de 5
...
⚠️ Avertissement surapprentissage (overfitting) : 19 968 combinaisons
...
TREND_EMA_PERIODS = range(3, 81, 5)
